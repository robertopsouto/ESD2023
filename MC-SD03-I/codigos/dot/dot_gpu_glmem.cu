...
int main(int argc, char* argv[])
{
    ...
    checkCuda( cudaMalloc( (void**)&dev_r, sizeof(float) ) );
    ...
    dot_reduction<<<GridSize,BlockSize>>>( dev_c, dev_r, N );

    // copy the result 'r' back from the GPU to the CPU
    checkCuda( cudaMemcpy( &r, dev_r, sizeof(float), cudaMemcpyDeviceToHost ) );
